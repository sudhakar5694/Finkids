...
altairApp
    ...
    .service('preloaders', [
        ...
        function($rootScope,$timeout,utils) {
            this.preloader_show = function(style,variant,container,width,height) {
                var $body = $('body');
...
altairApp
                    ...
                    $timeout(function() {
                        if(!$elem.hasClass('md-input-processed')) {
                            ...
                            if ($elem.prev('label').length) {
                                ...
                                $elem.siblings('[data-uk-form-password]').addBack().wrapAll('<div class="md-input-wrapper"/>');
                            } else {
                        ...
                        if(isOpen) {
                            ...
                            scope.dropdown
                                ...
                                .velocity('slideUp', {
                                    ...
                                    easing: [ 0.4,0,0.2,1 ],
                                    begin: function() {
                                        if($(element).next('.ui-select-validate').length) {
                                            $(element).next('.ui-select-validate').parsley().validate();
                                        };
                                    }
                                });
                        }
    ...
    // top bar filters
    .directive('topBarToggle', [
        function() {
            return {
                restrict: 'A',
                link: function (scope, el, attrs) {
                    $panelToggle = $(el);
                    if ($panelToggle.length) {
                        $panelToggle.on('click', function (e) {
                            e.preventDefault();
                            $('#top_bar').toggleClass('top_bar_panel_active');
                        })
                    }
                }
            }
            ...
            return {
                ...
                link: function (scope, el, attrs) {
                    ...
                    $columnToggle.on('click', function (e) {
                        e.preventDefault();
                        var $this = $(this);
                        var $column = $this.closest('.js_collapsible_column');
                        var collapsed = $column.hasClass('collapsed');
                        $this.children().toggle();
                        $column.toggleClass('in-transition collapsed');
                        setTimeout(function () {
                            $column.removeClass('in-transition');
                            if(collapsed) {
            ...
            $ocLazyLoadProvider.config({
                ...
                modules: [
                    ...
                    },
                    {
                        name: 'lazy_tour',
                        files: [
                            'assets/js/custom/enjoyhint.min.js'
                        ]
                    },
                    {
                        ...
                        files: [
                            ...
                            'file_manager/js/extras/tinymceElfinder.js'
                        ],
			            insertBefore: '#main_stylesheet',
                        serie: true
                    },
                    ...
                    {
                        name: 'lazy_clear_button',
                        files: [
                            'bower_components/Add-Clear/addclear.min.js'
                        ]
                    },
                    ...
                    // ----------- KENDOUI COMPONENTS -----------
                    {
                        ...
                        files: [
                            ...
                            'bower_components/kendo-ui/js/kendo.button.min.js',
