altairApp
    .config([
        ...
        function($stateProvider, $urlRouterProvider, $locationProvider) {
            ...
            //-learning cockpit--
            .state("restricted.Learning", {
                    url: "/learning",
                    template: '<div ui-view autoscroll="false"/>',
                    abstract: true
                })
                .state("restricted.Learning.my_progress", {
                    url: "/my_progress",
                    templateUrl: 'app/components/Learning/my_progressView.html',
                    controller: 'my_progressCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load('app/components/learning/my_progressController.js');
                        }]
                    },
                    data: {
                ...
                .state("restricted.Learning.my_lesson", {
                    url: "/my_lesson",
                    templateUrl: 'app/components/Learning/my_lessonview.html',
                    controller: 'my_lessonCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load('app/components/learning/my_lessonController.js');
                        }]
                    },
                    data: {
            ...
            .state("restricted.Investment", {
                    url: "/Investment",
                    template: '<div ui-view autoscroll="false"/>',
                    abstract: true
                })
                .state("restricted.Investment.my_wallet", {
                    url: "/my_wallet",
                    templateUrl: 'app/components/Investment/my_walletView.html',
                    controller: 'walletCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load('app/components/Investment/my_walletController.js');
                        }]
                    },
                    data: {
                        pageTitle: 'my wallet'
            ...
            //---banking
            .state("restricted.Investment.banking", {
                    url: "/banking",
                    template: '<div ui-view autoscroll="false"/>',
                    abstract: true

                })
                .state("restricted.Investment.banking.account", {
                    url: "/account",
                    templateUrl: 'app/components/Investment/banking/accountView.html',
                    controller: 'accountCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load('app/components/Investment/banking/accountController.js');
                        }]
                    },
                    data: {
                        pageTitle: 'account'
            ...
            .state("restricted.Investment.banking.saving", {
                url: "/saving",
                templateUrl: 'app/components/Investment/banking/savingView.html',
                controller: 'savingCtrl',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load('app/components/Investment/banking/savingController.js');
                    }]
                },
                data: {
                    pageTitle: 'saving'
            ...
            .state("restricted.Investment.banking.fixed_deposit", {
                url: "/fixed_deposit",
                templateUrl: 'app/components/Investment/banking/fixed_depositView.html',
                controller: 'fixed_depositCtrl',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load('app/components/Investment/banking/fixed_depositController.js');
                    }]
                },
                data: {
                    pageTitle: 'fixed investment'
                }
            })
            ...
            .state("restricted.Investment.my_insurance", {
                url: "/my_insurance",
                templateUrl: 'app/components/Investment/my_insuranceview.html',
                controller: 'my_insuranceCtrl',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load('app/components/Investment/my_insuranceController.js');
                    }]
                },
                data: {
                    pageTitle: 'MY Insurance'
                }
            })
            ...
            .state("restricted.Investment.my_jewellery", {
                url: "/my_jewellery",
                templateUrl: 'app/components/Investment/my_jewelleryview.html',
                controller: 'my_jewellaryCtrl',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load('app/components/Investment/my_jewelleryController.js');
                    }]
                },
                data: {
                    pageTitle: 'My jewellery'
                }
            })
            ...
            // .state("restricted.Investment.mystock", {
            //         url: "/mystock",
            //         template: '<div ui-view autoscroll="false"/>',
            //         abstract: true

            //     })
            .state("restricted.Investment.my_stockportfolio", {
                url: "/my_stockportfolio",
                templateUrl: 'app/components/Investment/my_stockportfolioview.html',
                controller: 'my_stockportfolioCtrl',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load('app/components/Investment/my_stockportfolioController.js');
                    }]
                },
                data: {
                    pageTitle: 'my stockportfolio'
                }
            })


            .state("restricted.Investment.stock_search", {
                url: "/stock_search",
                templateUrl: 'app/components/Investment/stock_searchview.html',
                controller: 'my_jewellaryCtrl',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load('app/components/Investment/stock_searchController.js');
                    }]
                },
                data: {
            ...
            .state("restricted.Investment.my_portfolio", {
                url: "/my_portfolio",
                templateUrl: 'app/components/Investment/my_portfolioview.html',
                controller: 'my_jewellaryCtrl',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load('app/components/Investment/stock_searchController.js');
            ...
            .state("restricted.Investment.my_charity", {
                url: "/my_charity",
                templateUrl: 'app/components/Investment/my_charityview.html',
                controller: 'my_charityCtrl',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load('app/components/Investment/my_charityController.js');
                    }]
                },
                data: {
            ...
            .state("restricted.myinfo.my_profile", {
                url: "/my_profile",
                templateUrl: 'app/components/myinfo/my_profileview.html',
                controller: 'my_profileCtrl',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load('app/components/myinfo/my_profileController.js');
                    }]
                },
                data: {
            ...
            .state("restricted.myinfo.my_subscription", {
                url: "/my_subscription",
                templateUrl: 'app/components/myinfo/my_subscriptionview.html',
                controller: 'my_subscriptionCtrl',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load('app/components/myinfo/my_subscriptionController.js');
                    }]
                },
                data: {
            ...
            .state("restricted.mysupport.my_issues", {
                url: "/my_issues",
                templateUrl: 'app/components/mysupport/my_issuesview.html',
                controller: 'my_issuesCtrl',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load('app/components/mysupport/my_issuesController.js');
                    }]
                },
                data: {
                    pageTitle: 'My issues'
            ...
            .state("restricted.Bussiness_dashboard", {
                    url: "/Bussiness_dashboard",
                    template: '<div ui-view autoscroll="false"/>',
                    abstract: true
                })
                .state("restricted.Bussiness_dashboard.salesdashboard", {
                    url: "/salesdashboard",
                    templateUrl: 'app/components/Bussiness_dashboard/salesdashboardview.html',
                    controller: 'salesdashboardCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load('app/components/Bussiness_dashboard/salesdashboardController.js');
                        }]
                    },
                    data: {
            ...
            .state("restricted.Learning_dashboard", {
                    url: "/Learning_dashboard",
                    template: '<div ui-view autoscroll="false"/>',
                    abstract: true
                })
                .state("restricted.Learning_dashboard.learningdashboard", {
                    url: "/learning_board",
                    templateUrl: 'app/components/Learning_dashboard/learningdashboardview.html',
                    controller: 'salesdashboardCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load('app/components/Learning_dashboard/learningdashboardController.js');
                        }]
                    },
                    data: {
            ...
            .state("restricted.support_dashboard", {
                    url: "/support_dashboard",
                    template: '<div ui-view autoscroll="false"/>',
                    abstract: true
                })
                .state("restricted.support_dashboard.supportdashboard", {
                    url: "/learning_board",
                    templateUrl: 'app/components/support_dashboard/supportdashboardview.html',
                    controller: 'salesdashboardCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load('app/components/support_dashboard/supportdashboardController.js');
                        }]
                    },
                    data: {
            ...
            //         abstract: true
            //     })
            //     .state("restricted.Investment.wallet.my_wallet", {
            //         url: "/my_wallet",
            //         templateUrl: 'app/components/Investment/wallet/my_walletview.html',
            //         controller: 'regularCtrl',
            //         resolve: {
            //             deps: ['$ocLazyLoad', function($ocLazyLoad) {
            //                 return $ocLazyLoad.load('app/components/Investment/wallet/my_walletcontroller.js');
            //             }]
            //         },
            //         data: {
            //             pageTitle: 'wallet'
            ...
            .state("restricted.forms.stocks", {
                    url: "/stocks",
                    templateUrl: 'app/components/forms/stocksView.html',
                    controller: 'stocks  Ctrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load('app/components/forms/regularController.js');
                        }]
            ...
            .state("restricted.kendoui", {
                ...
                .state("restricted.components.collapsible_columns", {
                    url: "/collapsible_columns",
                    templateUrl: 'app/components/components/collapsible_columnsView.html',
                    data: {
                        pageTitle: 'Collapsible Columns (components)'
                    }
                })
            ...
            .state("restricted.pages", {
                ...
                .state("restricted.pages.fixed_deposits", {
                    url: "/fixed_deposits",
                    templateUrl: 'app/components/pages/fixed_depositsView.html',
                    data: {
                        pageTitle: 'Blank Page'
                    }
