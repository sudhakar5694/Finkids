...
// -------------------- PROCESS ALL JS --------------------
gulp.task('js_all', function(callback) {
    return runSequence(
        ['js_angular_common','js_app','js_app_minify','js_common'],
        'js_minify',
        callback
    );
});
...
// -------------------- PROCESS ALL LESS ------------------
gulp.task('less_all', function(callback) {
    return runSequence(
        'less_main',
        ['less_themes','less_my_theme','less_style_switcher'],
        callback
    );
});
